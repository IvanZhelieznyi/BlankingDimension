const findBlankingDimensionBtn = document.querySelector('#find-blanking-dimension-btn');

const findBlankingDimension = document.querySelector('#find-blanking-dimension');
...
const modals = [findBlankingDimension];
const buttons = [findBlankingDimensionBtn];
